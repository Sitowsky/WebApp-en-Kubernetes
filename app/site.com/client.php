	...
	<div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<label>Phone</label>
					<input type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="PhoneClientu" class="form-control input-sm">
				</div>
				<div class="modal-body">
					<label>E-mail</label>
					<input type="email" id="EmailClientu" class="form-control input-sm">
				</div>
		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					En el apartado siguiente puede agregar, modificar y eliminar clientes.
				</p>
			</div>
		</section>
							...
							<div class="full-width panel-content">
								<form id="frmajax" method="POST">
									<div class="mdl-grid">
										...
										<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" name="PhoneClient" id="PhoneClient">
										...
										<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="email" name="EmailClient" id="EmailClient">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#guardarnuevo').click(function() {
			...
			agregardatos(nombre, tel, correo);
			$('#NameClient').val("");
			$('#PhoneClient').val("");
			$('#EmailClient').val("");
		});
