            ...
            <tbody>
                ...
                if (isset($_SESSION['consulta'])) {
                    if ($_SESSION['consulta'] > 0) {
                        ...
                        $sql = "SELECT id_producto,nombre_producto,des_producto,precio,
                        url,nombre_proveedor,nombre_categoria,producto.id_proveedor,producto.id_categoria from producto join
                        proveedor on producto.id_proveedor = proveedor.id_proveedor join categoria 
                        on categoria.id_categoria = producto.id_categoria where id_producto='$idp'";
                    } else {
                        $sql = "SELECT id_producto,nombre_producto,des_producto,precio,
                        url,nombre_proveedor,nombre_categoria,producto.id_proveedor,producto.id_categoria from producto join
                        proveedor on producto.id_proveedor = proveedor.id_proveedor join categoria 
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td align="center"><img src="images/<?php echo $ver[4] ?>" width="50" height="50"></td>
